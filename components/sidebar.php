    ...
    <div>
        ...
        <nav class="mt-6 space-y-1">
            ...
            <a href="send-notification.php"
                class="block py-2.5 px-4 rounded transition duration-200 hover:bg-brand-800 hover:text-white <?php echo basename($_SERVER['PHP_SELF']) == 'send-notification.php' ? 'bg-brand-800 font-bold' : ''; ?>">
                <span class="flex items-center space-x-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <?php if (function_exists('isAdmin') && isAdmin()): ?>
                <a href="users.php"
                    class="block py-2.5 px-4 rounded transition duration-200 hover:bg-brand-800 hover:text-white <?php echo in_array(basename($_SERVER['PHP_SELF']), ['users.php', 'user-add.php', 'user-edit.php']) ? 'bg-brand-800 font-bold' : ''; ?>">
                    <span class="flex items-center space-x-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
