...
<body class="bg-brand-50 flex h-screen overflow-hidden text-gray-800">
    ...
    <div class="flex-1 flex flex-col min-h-screen overflow-hidden">
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-brand-50 p-3 sm:p-5">
            <!-- Header Title -->
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-2">
                <div>
                    <h1 class="text-2xl sm:text-3xl font-bold text-brand-900">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
                ...
                <div class="contents lg:flex lg:flex-col lg:space-y-4 lg:col-span-5">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden order-1">
                        ...
                        <button type="button" onclick="toggleAccordion('routeAccordionContent', 'routeAccordionArrow')"
                            ...
                            <span
                                class="text-xs font-bold text-gray-800 uppercase tracking-wider flex items-center gap-2">
                        ...
                        <div id="routeAccordionContent" class="p-3.5 sm:p-4">
                            ...
                            <div class="bg-emerald-50/70 border border-emerald-200 rounded-lg p-3 relative mb-2">
                                ...
                                <div id="originDisplayInfo"
                                    ...
                                    <span id="originCoordsBadge"
                                        class="hidden font-mono bg-emerald-200/80 px-1.5 py-0.2 rounded text-[10px]">GPS
                                        OK</span>
                                </div>
                            </div>
                            ...
                            <div class="flex justify-center -my-2 relative z-10">
                                <button type="button" onclick="swapOriginDestination()"
                            ...
                            <div class="bg-rose-50/70 border border-rose-200 rounded-lg p-3 relative mt-2">
                                ...
                                <div id="destDisplayInfo"
                                    ...
                                    <span id="destCoordsBadge"
                                        class="hidden font-mono bg-rose-200/80 px-1.5 py-0.2 rounded text-[10px]">GPS
                                        OK</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden order-3">
                        <!-- Accordion Header -->
                        <button type="button"
                            onclick="toggleAccordion('financialAccordionContent', 'financialAccordionArrow')"
                            class="w-full flex items-center justify-between p-3.5 sm:p-4 bg-white hover:bg-gray-50/80 transition cursor-pointer text-left border-b border-gray-100">
                            <span
                                class="text-xs font-bold text-gray-800 uppercase tracking-wider flex items-center gap-2">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <svg id="financialAccordionArrow"
                                    class="w-4 h-4 text-gray-400 transition-transform duration-200 transform"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M19 9l-7 7-7-7"></path>
                        ...
                        <div id="financialAccordionContent" class="p-3.5 sm:p-4 space-y-3.5">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                ...
                                <div>
                                    <label class="block text-[11px] font-bold text-gray-600 mb-1">Distância (Só
                                        Ida)</label>
                                    <div class="relative">
                                ...
                                <div>
                                    <div class="flex items-center justify-between mb-1">
                                        <label class="block text-[11px] font-bold text-brand-900">Distância Total
                                            (x2)</label>
                                        <span
                                            class="text-[9px] font-extrabold px-1.5 py-0.2 bg-brand-100 text-brand-800 rounded">Ida
                                            e Volta</span>
                                    </div>
                                    <div class="relative">
                                        ...
                                        <span
                                            class="absolute inset-y-0 right-0 flex items-center pr-2 pointer-events-none text-[10px] font-bold text-brand-600 uppercase">KM
                                            Total</span>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <label class="block text-[11px] font-bold text-gray-600 mb-1">Valor por KM
                                        Rodado</label>
                                    <div class="relative">
                                        <span
                                ...
                                <div>
                                    <label class="block text-[11px] font-bold text-gray-600 mb-1">Qtd. Total de
                                        Animais</label>
                                    <div class="relative">
                            ...
                            <div
                                class="bg-gray-50 border border-gray-200 rounded-lg p-3 text-xs text-gray-600 space-y-1">
                                <div class="flex items-center justify-between text-[11px]">
                                    <span class="text-gray-500 font-semibold">Trajeto:</span>
                                    <span id="summaryRouteDesc"
                                        class="font-bold text-gray-800 truncate max-w-[200px] text-right">Não
                                        definido</span>
                                </div>
                                <div class="flex items-center justify-between text-[11px]">
                ...
                <div
                    class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden order-2 lg:col-span-7 flex flex-col">
                    <!-- Accordion Header -->
                    ...
                    <div id="mapAccordionContent" class="p-2 sm:p-3 flex-1 flex flex-col space-y-2">
                        <?php if (defined('MAP_PROVIDER') && MAP_PROVIDER === 'google_maps'): ?>
                            <div
                                class="bg-brand-50/80 border border-brand-200/70 rounded-lg px-3 py-2 flex items-center justify-between gap-2">
                                <span class="text-[11px] text-brand-900 font-medium leading-tight">
                                    💡 <strong>Dica:</strong> Você pode <strong>clicar e arrastar a linha azul</strong> da
                                    rota no mapa para alterar trajetos e simular rodovias alternativas.
                                </span>
                            </div>
                        <?php else: ?>
                            <div
                                class="flex items-center justify-between bg-blue-50/70 border border-blue-200 rounded-lg px-3 py-1.5 gap-2">
                        ...
                        <div class="relative flex-1 w-full overflow-hidden rounded-lg border border-gray-200">
                            <div id="freightMap" class="w-full h-[400px] lg:h-[calc(100vh-230px)] lg:min-h-[560px]">
                            </div>
    ...
    <?php if (defined('MAP_PROVIDER') && MAP_PROVIDER === 'google_maps'): ?>
        ...
        <script
            src="https://maps.googleapis.com/maps/api/js?key=<?php echo GOOGLE_MAPS_API_KEY; ?>&libraries=places&loading=async&callback=initFreightMap"
            async defer></script>
    <?php else: ?>
