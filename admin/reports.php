                            ...
                            <table class="min-w-full leading-normal">
                                <thead>
                                    <tr class="bg-gray-100/80 text-gray-700 text-left text-xs font-bold uppercase tracking-wider border-b border-gray-200">
                                        ...
                                        <th class="px-5 py-3 text-center">Mapa</th>
                                    </tr>
                                </thead>
                                <tbody class="divide-y divide-gray-100">
                                    <?php foreach ($results as $item): ?>
                                        <tr class="hover:bg-brand-50/30 transition">
                                            ...
                                            <td class="px-5 py-4 bg-white text-sm">
                                                ...
                                                <div class="text-gray-500 text-xs mt-1">
                                                    <?php if (!empty($item['phone'])): ?>
                                                        <a href="https://wa.me/+55<?php echo preg_replace('/[^0-9]/', '', $item['phone']); ?>"
                                                            target="_blank"
                                                            class="text-green-600 hover:text-green-800 font-semibold hover:underline inline-flex items-center client-phone text-xs mb-0.5"
                                                            ...
                                                            <span><?php echo htmlspecialchars(formatPhone($item['phone'])); ?></span>
                                                        </a>
                                                    <?php endif; ?>
                                            ...
                                            <!-- Mapa Action Column -->
                                            <td class="px-5 py-4 bg-white text-sm whitespace-nowrap text-center">
                                                <?php if (!empty($item['latitude']) && !empty($item['longitude'])): ?>
                                                    <a href="view-map.php?client_id=<?php echo $item['client_id']; ?>"
                                                        class="text-emerald-600 hover:text-emerald-800 p-1.5 hover:bg-emerald-50 rounded transition inline-flex items-center"
                                                ...
                                                <?php else: ?>
                                                    <span class="text-gray-400 text-xs" title="Cliente sem coordenadas cadastradas">-</span>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
