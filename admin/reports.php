            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-brand-50 p-6">
                    ...
                    <form method="GET" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                        <div>
                            ...
                            <select name="status" class="w-full border p-2 rounded text-sm">
                                ...
                                <option value="Embral" <?php echo $status_filter==='Embral' ? 'selected' : ''; ?>>Embral</option>
                        ...
                        <div>
                            ...
                            <select name="breed" class="w-full border p-2 rounded text-sm">
                                ...
                                <?php foreach (['Jersey', 'Holandês', 'Gersolando', 'Girolando', 'Gir', 'Máquinas'] as $b): ?>
                                    <option value="<?php echo $b; ?>" <?php echo $breed_filter===$b ? 'selected' : ''; ?>><?php echo $b; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="payment" class="w-full border p-2 rounded text-sm">
                                ...
                                <?php foreach (['10 pagamentos', '12 pagamentos', '15 pagamentos', 'À vista'] as $p): ?>
                                    <option value="<?php echo $p; ?>" <?php echo $payment_filter===$p ? 'selected' : ''; ?>><?php echo $p; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                ...
                <div class="bg-white shadow rounded-lg overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                        ...
                        <span class="bg-brand-100 text-brand-800 px-3 py-1 rounded-full text-sm font-bold border border-brand-200">
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        ...
                                        <div class="text-gray-500 text-xs mt-1">
                                            ...
                                            <?php if (!empty($item['email'])): ?>
                                                <span class="block text-gray-400 text-xs"><?php echo htmlspecialchars($item['email']); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        ...
                                        <?php if (!empty($item['intention_id'])): ?>
                                            <div class="flex items-center gap-2">
                                                <?php if ($item['type'] == 'buy'): ?>
                                                    <span class="bg-blue-100 text-blue-800 text-xs px-2 py-0.5 rounded font-bold">Compra</span>
                                                <?php else: ?>
                                                    <span class="bg-red-100 text-red-800 text-xs px-2 py-0.5 rounded font-bold">Venda</span>
                                                <?php endif; ?>
                                            ...
                                            <div class="text-xs text-gray-500 mt-1 max-w-xs truncate" title="<?php echo htmlspecialchars($item['description']); ?>">
